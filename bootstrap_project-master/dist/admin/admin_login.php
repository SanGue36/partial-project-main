...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous" href="admin_login.css">
  ...
  <body data-home-page="Profile.html" data-home-page-title="Profile" class="u-body u-xl-mode" data-lang="en">
    ...
    <section class="u-border-12 u-border-grey-10 u-clearfix u-white u-section-1" id="sec-0cb2">
      <div class="u-clearfix u-sheet u-sheet-1">
        <img class="u-image u-image-circle u-image-1" src="" alt="" data-image-width="400" data-image-height="265">
                      ...
                      <div class="row">
                        <div class="col-md-6 mb-4">
                          ...
                          <div class="form-outline">
                            <input type="text" id="firstName" class="form-control form-control-lg" required name="username" value="<?php echo $username; ?>">
                      ...
                      <div class="row">
                        <div class="col-md-6 mb-4 d-flex align-items-center">
                          ...
                          <div class="form-outline datepicker w-100">
                            <input type="text" class="form-control form-control-lg" id="birthdayDate"  required name="password" value="<?php echo $password; ?>">
